      ...
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-6 lg:px-8">
        ...
        <div className="hidden md:grid md:grid-cols-5 gap-8 items-start">
          ...
          <div className="col-span-1 flex flex-col items-start text-left">
            ...
            <p className="mt-4 text-sm text-neutral-600 dark:text-neutral-400">
              Rumah Sakit Nuha - Melayani dengan hati, merawat dengan kasih.
            </p>
          </div>

          {/* Footer Links - 4 columns (Product, Company, Resources, Social) */}
          {footerLinks.map((section, idx) => (
            <div key={`footer-section-${idx}`} className="col-span-1 flex flex-col items-start text-left">
        ...
        <div className="md:hidden">
          ...
          <div className="grid grid-cols-2 gap-6">
            {footerLinks.map((section, idx) => (
              <div key={`mobile-section-${idx}`} className="flex flex-col items-center text-center">
        ...
        <div className="mt-12 border-t border-neutral-200 pt-8 dark:border-neutral-800">
          <div className="flex flex-col items-center justify-center gap-4 md:flex-row md:justify-between">
            <p className="text-sm text-neutral-600 dark:text-neutral-400 text-center md:text-left">
              © {new Date().getFullYear()} RS Nuha. Hak cipta dilindungi.
            </p>
